const menus = [{jour:"23 février",
    ...
    plats:["Falafel Burger: Bun's au sarrasin, galette de pois-chiche frite, coleslaw, sauce tahini , accompagné de pommes de terre sautées.", 
    ...
    plats:["Poêlée poireaux champignons échalotes, Tagliatelle maison, sauce Gorgonzola",
    ...
    plats:["Brandade de lieu au citron vert et brocoli vapeur",
    ...
    plats:["Saucisse aux herbes et polenta crémeuse, sauce au vin rouge thym et oignons confits",
